...
class NewsFeedViewController: UIViewController {
    ...
    @IBAction func getDataTapped(_ sender: Any) {
        self.handleDataTapped()
    }
    
    func handleDataTapped(){
        
        let jsonUrl = "http://newsapi.org/v2/everything?q=tesla&from=2021-02-12&sortBy=publishedAt&apiKey=d04ed0d9ce5843509c4a77c9c20faf16"
